...
<div class="page-header" style="margin-bottom: 28px;">
    <div class="page-title-group">
        <h1>New Party</h1>
        <p class="font-urdu" style="margin-top:4px;">نیا گاہک / دوکاندار / کاریگر</p>
    </div>
</div>
...
<form action="{{ route('customers.store') }}" method="POST">
    ...
    <div class="form-section">
        ...
        <div class="input-grid">
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="filter-control" placeholder="Enter name" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="phone" id="phone" class="filter-control" placeholder="03XX-XXXXXXX">
            </div>
            <div class="form-group">
                <label for="cnic">CNIC <span class="font-urdu">شناختی کارڈ</span></label>
                <input type="text" name="cnic" id="cnic" class="filter-control" placeholder="XXXXX-XXXXXXX-X">
            </div>
            <div class="form-group">
                <label for="city">City <span class="font-urdu">شہر</span></label>
                <input type="text" name="city" id="city" class="filter-control" placeholder="City name">
            </div>
            <div class="form-group">
                <label for="opening_balance">Opening Balance (grams) <span class="font-urdu">ابتدائی بقایا</span></label>
                <div style="position:relative;">
                    <input type="number" step="0.001" name="opening_balance" id="opening_balance" class="filter-control" placeholder="0.000" value="0">
            ...
            <div class="form-group full-width">
                ...
                <textarea name="address" id="address" class="filter-control" rows="2" placeholder="Full address..."></textarea>
            </div>
        </div>
    </div>
    ...
    <div style="display:flex; gap:14px; margin-top:8px;">
        <button type="submit" class="btn-gold">
            <i class="bi bi-save"></i> Save Party
        </button>
